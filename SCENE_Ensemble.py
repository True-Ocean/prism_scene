...
# ----------------------------------------------------
# 1. 勝敗（Win_A）と着順差（Order_Diff）の計算（変更なし）
# ----------------------------------------------------
...
Final_Pair_df.to_sql('FinalPair', con=engine, if_exists = 'replace')
