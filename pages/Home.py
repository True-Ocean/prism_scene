...
st.markdown("""
### このサイトについて
**PRISM_SCENE**は、競走馬のパフォーマンスデータを多角的に分析し、
定量的なスコアとGeminiによる定性的なナラティブ（物語）を統合するシステムです。

            
### **主な機能:**
- **プリズム（PRISM）分析**: 出走各馬の多様なデータと過去20年間の競馬データベースをもとに定量的に分析した結果を、わかりやすくグラフで可視化しています。
- **シーン（SCENE）分析**: 出走各馬の多様なデータから割り出した特徴、キャラ、ライバル関係をもとに、全馬の世界線でレースをシミュレーションしています。
- **プリズム・シーン（PRISM_SCENE）分析**: 最終的に割り出されたレース展開をベースに『とある世界線の物語』として描き出し、レース実況音声を生成しています。またレース後には、上位3キャラによるアフターストーリーを生成します。
""")
...
st.markdown("""
### 📝 更新履歴
- 2026/3/7: 弥生賞ディープインパクト記念 を公開
- 2026/3/6: 中山牝馬S を公開
- 2026/3/6: フィリーズレビュー を公開
- 2026/2/20: フェブラリーS を公開
- 2025/12/30: ジャパンC を公開
- 2025/12/30: ホープフルS を公開
- 2025/12/30: 有馬記念 を公開
