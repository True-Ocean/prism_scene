...
# Google Cloud Storage のバケット名
sub_dir_name = "archive/20260124_小倉牝馬S" # ================================= ここを書き換え =====================================
...
# --- メイン画面の表示 ---
st.title('🐎 2026年1月24日 小倉牝馬S') # ここを変更 =================================================================
st.divider()
...
if sub_menu == "基礎能力と先行指数":
    ...
    st.write(f"【横軸】 EPI: Early Pace Index（先行指数）は、過去のレース実績のAve-3F（前半600m換算タイム）をもとに評価された指標で、数値が高いほど序盤で逃げ・先行に向かう傾向があることを示します。")
    ...
    if Final_Mark_df is not None:
        ...
        【 ドラマ 】: 残ったキャラの中で、最高位が "1着" かつ "「ライバル関係」を有する" キャラ  
        【 ロマン 】: 残ったキャラの中で、最高位が "1着" または 複勝率がトップ のキャラ  
        【ドリーム】: 残ったキャラの中で、最高位が "1着" かつ "最も勝率が低い" キャラ
        """)
