...
def show_new_auth():
    ...
    if st.session_state.authenticated:
        ...
        st.title('🐎 2026年4月19日 皐月賞')# タイトルを変更 =============================================
        ...
        st.divider()
        # 🔑 スペシャルコンテンツの内容を表示
        with open("pages/20260419_皐月賞.py", encoding="utf-8") as f: # .pyファイル名を指定 =============================================
...
new_page = st.Page(show_new_auth, title="2026/4/19 皐月賞", icon="🔥") # タイトルを変更 =================================
