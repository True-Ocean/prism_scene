...
def show_new_auth():
    ...
    if st.session_state.authenticated:
        ...
        st.title('🐎 2026年5月17日 ヴィクトリアマイル')# タイトルを変更 =============================================
        ...
        st.divider()
        # 🔑 スペシャルコンテンツの内容を表示
        with open("pages/20260517_ヴィクトリアマイル.py", encoding="utf-8") as f: # .pyファイル名を指定 =============================================
            code = compile(f.read(), "pages/20260517_ヴィクトリアマイル.py", 'exec') # .pyファイル名を指定 =============================================
            exec(code, globals())
...
def show_archives():
    ...
    archive_options = {
        "選択してください": None,
        "2026/5/10 NHKマイルカップ": "20260510_NHKマイルカップ.py",
...
new_page = st.Page(show_new_auth, title="2026/5/17 ヴィクトリアマイル", icon="🔥") # タイトルを変更 =================================
