...
def show_new_auth():
    ...
    if st.session_state.authenticated:
        ...
        st.title('🐎 2026年4月12日 桜花賞')# タイトルを変更 =============================================
        ...
        st.divider()
        # 🔑 スペシャルコンテンツの内容を表示
        with open("pages/20260412_桜花賞.py", encoding="utf-8") as f: # .pyファイル名を指定 =============================================
            code = compile(f.read(), "pages/20260412_桜花賞.py", 'exec')
            exec(code, globals())
...
new_page = st.Page(show_new_auth, title="2026/4/12 桜花賞", icon="🔥") # タイトルを変更 =================================
