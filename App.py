...
def show_new_auth():
    ...
    if st.session_state.authenticated:
        ...
        st.title('🐎 2026年5月31日 東京優駿')# タイトルを変更 =============================================
        ...
        st.divider()
        # 🔑 スペシャルコンテンツの内容を表示
        with open("pages/20260531_東京優駿.py", encoding="utf-8") as f: # .pyファイル名を指定 =============================================
            code = compile(f.read(), "pages/20260531_東京優駿.py", 'exec') # .pyファイル名を指定 =============================================
            exec(code, globals())
...
new_page = st.Page(show_new_auth, title="2026/5/31 東京優駿", icon="🔥") # タイトルを変更 =================================
